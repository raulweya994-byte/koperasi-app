            ...
            <div class="card shadow-sm" style="border-radius:16px;border:none">
                <div class="card-header" style="background:linear-gradient(135deg,#667eea,#764ba2);border-radius:16px 16px 0 0;border:none">
                    <h5 class="mb-0 text-white font-weight-bold">
                        <i class="fas fa-plus-circle mr-2"></i>Form Tambah Program Bantuan
                    </h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('pimpinan.laporan.bantuan.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="kode_bantuan" class="form-control @error('kode_bantuan') is-invalid @enderror" 
                                       value="{{ old('kode_bantuan') }}" placeholder="Contoh: BNT-2025-001" required>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="nama_bantuan" class="form-control @error('nama_bantuan') is-invalid @enderror" 
                                       value="{{ old('nama_bantuan') }}" placeholder="Contoh: Bantuan Modal Usaha Koperasi" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="jenis_bantuan" class="form-control @error('jenis_bantuan') is-invalid @enderror" required>
                                    ...
                                    <option value="uang" {{ old('jenis_bantuan') == 'uang' ? 'selected' : '' }}>Uang</option>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" 
                                          rows="3" placeholder="Jelaskan tujuan dan detail program bantuan...">{{ old('deskripsi') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="anggaran" class="form-control @error('anggaran') is-invalid @enderror" 
                                       value="{{ old('anggaran', 0) }}" min="0" step="1000" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="satuan" class="form-control @error('satuan') is-invalid @enderror" 
                                       value="{{ old('satuan') }}" placeholder="Contoh: Unit, Paket, Kg">
