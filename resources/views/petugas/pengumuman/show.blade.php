    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <a href="{{ route('petugas.pengumuman.index') }}" class="btn btn-secondary" style="border-radius:8px">
                ...
                <div>
                    ...
                    <a href="{{ route('petugas.pengumuman.download', $pengumuman->id) }}" class="btn btn-primary" style="border-radius:8px">
    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            <div class="card shadow-sm" id="printArea" style="border-radius:16px;border:none;overflow:hidden">
                ...
                {{-- Header (Web Only) --}}
                <div class="card-header border-0 no-print" style="background:{{ $pengumuman->jenis == 'info' ? 'linear-gradient(135deg,#06b6d4,#0891b2)' : ($pengumuman->jenis == 'warning' ? 'linear-gradient(135deg,#f59e0b,#d97706)' : ($pengumuman->jenis == 'success' ? 'linear-gradient(135deg,#10b981,#059669)' : 'linear-gradient(135deg,#ef4444,#dc2626)')) }};padding:40px">
                    ...
                    <div class="row no-print">
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="d-flex align-items-center">
                                <div style="width:50px;height:50px;background:linear-gradient(135deg,#06b6d4,#0891b2);border-radius:12px;display:flex;align-items:center;justify-content:center;margin-right:15px">
            ...
            <div class="row mt-4 no-print">
                @if($pengumuman->user && $pengumuman->user->role == 'petugas')
                <div class="col-md-6 mb-3">
                    <div class="card shadow-sm" style="border-radius:12px;border:none">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="{{ route('petugas.pengumuman.edit', $pengumuman->id) }}" class="btn btn-warning btn-block" style="border-radius:8px">
                ...
                <div class="col-md-6 mb-3">
                    <div class="card shadow-sm" style="border-radius:12px;border:none">
                        <div class="card-body text-center p-4">
                            ...
                            <form action="{{ route('petugas.pengumuman.destroy', $pengumuman->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus pengumuman ini?')">
                                @csrf
                                @method('DELETE')
                ...
                @else
                <div class="col-12">
                    <div class="alert alert-info" style="border-radius:12px;border:none;border-left:4px solid #06b6d4">
...
document.addEventListener('keydown', function(e) {
    ...
    // ESC untuk kembali
    if (e.key === 'Escape') {
        window.location.href = '{{ route("petugas.pengumuman.index") }}';
    }
});
</script>
@endpush
