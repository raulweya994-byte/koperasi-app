...
<div class="container-fluid">
    ...
    <div class="mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="{{ route('petugas.bantuan.konfirmasi', $bantuan) }}" class="btn btn-warning ml-2" style="border-radius: 10px; padding: 10px 24px; font-weight: 600;">
                <i class="fas fa-check-circle mr-2"></i>Konfirmasi Penyaluran
            </a>        </div>
    ...
    <div class="table-card-modern">
        <div class="table-card-header">
            <h5 class="table-card-title">
                ...
                <span class="badge badge-primary ml-2" style="font-size: 12px;">{{ $penerima->count() }} Total</span>
            </h5>
        </div>
        ...
        @if($penerima->count() > 15)
        <div class="card-footer bg-white" style="padding: 20px 24px;">
            <div class="d-flex justify-content-between align-items-center">
                <small class="text-muted">
                    Menampilkan {{ 1 }}–{{ $penerima->count() }} dari {{ $penerima->count() }} data
                </small>
                <div>
...
<div class="modal fade" id="modalTambahPenerima" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border-radius: 16px; border: none;">
            <form action="{{ route('petugas.bantuan.tambahPenerima', ['bantuan' => 1]) }}" method="POST" id="formTambahPenerima">
                @csrf
