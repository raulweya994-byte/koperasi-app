  ...
  <div class="row mb-2">
    ...
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="{{ route('petugas.halaman-statis.index') }}">Halaman Statis</a></li>
...
<section class="content"><div class="container-fluid">
  ...
  <div class="card card-warning card-outline">
    ...
    <form method="POST" action="{{ route('petugas.halaman-statis.update', $halamanStatis->id) }}" enctype="multipart/form-data">
      @csrf @method('PUT')
      <div class="card-body">
      ...
      <div class="card-footer">
        ...
        <a href="{{ route('petugas.halaman-statis.index') }}" class="btn btn-secondary ml-2">Batal</a>
      </div>
    </form>
  </div>
</div></section>
