    ...
    <div class="filter-box-modern">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="btn-group">
                ...
                <a href="{{ route('petugas.anggota-koperasi.create') }}" class="btn btn-primary" style="border-radius:8px 0 0 8px;font-weight:600;">
        ...
        <form method="GET" action="{{ route('petugas.anggota-koperasi.index') }}" id="filterForm">
            <div class="row align-items-end">
                ...
                <div class="col-md-2 mb-3">
                    <a href="{{ route('petugas.anggota-koperasi.index') }}" class="btn btn-secondary btn-block" style="border-radius: 10px; font-weight: 600; padding: 10px;">
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-btn-group">
                            @if(can_view('anggota'))
                            <a href="{{ route('petugas.anggota-koperasi.show', $a) }}" class="btn btn-sm btn-info" title="Detail">
                                <i class="fas fa-eye"></i>
                            </a>
                            @endif
                            @if(can_edit('anggota'))
                            <a href="{{ route('petugas.anggota-koperasi.edit', $a) }}" class="btn btn-sm btn-warning" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            @endif
                            @if(can_delete('anggota'))
                            <form action="{{ route('petugas.anggota-koperasi.destroy', $a) }}" method="POST" style="display:inline" onsubmit="return confirmDelete(event)">
                                @csrf
                                @method('DELETE')
                ...
                <tr>
                    <td colspan="20">
                        <div class="empty-state">
                            ...
                            <a href="{{ route('petugas.anggota-koperasi.create') }}" class="btn btn-primary" style="border-radius:8px;">
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="d-flex justify-content-center">
                {{ $anggotaKoperasi->links('pagination::bootstrap-4') }}
            </div>
        </div>
    </div>
    @endif
