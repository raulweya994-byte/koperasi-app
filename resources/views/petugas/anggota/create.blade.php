            ...
            <div class="col-lg-10">
                ...
                <div class="alert alert-info" style="border-radius:12px;border:none;box-shadow:0 2px 8px rgba(0,0,0,0.1)">
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            ...
                            <p class="mb-1"><strong>Periode:</strong> {{ $periodeAktif->nama_periode }}</p>
                            <p class="mb-1"><strong>Tanggal:</strong> {{ $periodeAktif->tanggal_mulai->format('d M Y') }} - {{ $periodeAktif->tanggal_selesai->format('d M Y') }}</p>
                            @if($periodeAktif->kuota)
                            <p class="mb-0"><strong>Sisa Kuota:</strong> {{ $periodeAktif->sisa_kuota }} orang</p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="card" style="border-radius:16px;border:none;box-shadow:0 4px 20px rgba(0,0,0,0.08)">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('petugas.anggota.store') }}" method="POST" enctype="multipart/form-data" id="formPendaftaran">
                            @csrf
                            ...
                            <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                                ...
                                <div>
                                    ...
                                    <button type="submit" class="btn btn-success" id="btnSubmit" style="display:none">
                                        <i class="fas fa-save mr-2"></i>Simpan & Daftarkan
                                    </button>
                                </div>
                            </div>
                        </form>
