            ...
            <div class="card-body p-0">
                <table class="table table-hover mb-0">
                    <thead style="background: linear-gradient(135deg, #34495e 0%, #2c3e50 100%);">
                        <tr>
                            <th style="color: #ffffff !important;">Nama Usaha</th>
                            <th style="color: #ffffff !important;">Pemilik</th>
                            <th style="color: #ffffff !important;">Status Hadir</th>
                        </tr>
                    </thead>
                    <tbody>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('petugas.jadwal.edit',$jadwal) }}" class="btn btn-warning btn-sm w-100 mb-2"><i class="fas fa-edit mr-1"></i>Edit</a>
                <form action="{{ route('petugas.jadwal.destroy',$jadwal) }}" method="POST" onsubmit="return confirm('Hapus?')">
                    @csrf @method("DELETE")
