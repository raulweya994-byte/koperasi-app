...
<div class="card shadow-sm">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-calendar-plus mr-2 text-primary"></i>Buat Jadwal Baru</h3>
    </div>
    <div class="card-body">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror"
                           value="{{ old('judul') }}" placeholder="Contoh: Verifikasi Koperasi Distrik Bokondini" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="lokasi" class="form-control" value="{{ old('lokasi') }}" placeholder="Contoh: Aula DISPERINDAGKOP">
                </div>
                <div class="form-group">
        ...
        <a href="{{ route('petugas.jadwal.index') }}" class="btn btn-secondary ml-2">Batal</a>
        </form>
    </div>
</div>
@endsection
