        ...
        <div class="col-12">
            <div class="card shadow-sm" style="border-radius:16px;border:none;background:linear-gradient(135deg,#667eea,#764ba2)">
                <div class="card-body p-4">
                    ...
                    <form method="GET" action="{{ route('petugas.laporan.koperasi') }}" id="filterForm">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('petugas.laporan.koperasi') }}" class="btn btn-secondary" style="border-radius:10px">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <a href="{{ route('petugas.laporan.exportWord', array_merge(['type'=>'koperasi'], request()->only(['distrik', 'kategori', 'status']))) }}" 
                        ...
                        <div class="col-md-4 mb-3">
                            <a href="{{ route('petugas.laporan.exportExcel', array_merge(['type'=>'koperasi'], request()->only(['distrik', 'kategori', 'status']))) }}" 
                                ...
                                <tr style="border-bottom:2px solid #e5e7eb;transition:all 0.3s ease" 
                                    ...
                                    <td style="padding:15px;text-align:center">
                                        <div class="btn-group-modern" style="display:flex;gap:5px;justify-content:center">
                                            ...
                                            <a href="{{ route('petugas.koperasi.edit', $k->id) }}" 
