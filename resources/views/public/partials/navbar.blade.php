        ...
        <div class="collapse navbar-collapse" id="navbarMain">
            <ul class="navbar-nav mx-auto" style="gap: 8px;">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navProfil" role="button" data-toggle="dropdown" style="padding: 24px 16px; font-size: 14px; font-weight: 600; color: rgba(255,255,255,0.85); display: flex; align-items: center; gap: 6px;">
                    ...
                    <div class="dropdown-menu" style="border: none; border-radius: 12px; box-shadow: 0 12px 40px rgba(0,0,0,0.15); padding: 8px; min-width: 220px; margin-top: 0;">
                        ...
                        <a class="dropdown-item" href="{{ route('public.halaman', 'komitmen') }}" style="border-radius: 8px; padding: 10px 14px; font-size: 13px; font-weight: 600; color: #1a3a6e; display: flex; align-items: center; gap: 10px;">
                            <i class="fas fa-award" style="width: 18px; color: #f5a623;"></i> Komitmen
                        </a>
                        <a class="dropdown-item" href="{{ route('public.halaman', 'koperasi') }}" style="border-radius: 8px; padding: 10px 14px; font-size: 13px; font-weight: 600; color: #1a3a6e; display: flex; align-items: center; gap: 10px;">
                            <i class="fas fa-handshake" style="width: 18px; color: #f5a623;"></i> Koperasi
                        </a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown {{ request()->routeIs('public.berita*') || request()->routeIs('public.pengumuman*') ? 'active' : '' }}">
                    ...
                    <div class="dropdown-menu" style="border: none; border-radius: 12px; box-shadow: 0 12px 40px rgba(0,0,0,0.15); padding: 8px; min-width: 220px; margin-top: 0;">
                        <a class="dropdown-item" href="{{ route('public.pengumuman') }}" style="border-radius: 8px; padding: 10px 14px; font-size: 13px; font-weight: 600; color: #1a3a6e; display: flex; align-items: center; gap: 10px;">
                            <i class="fas fa-clipboard" style="width: 18px; color: #f5a623;"></i> Pengumuman
                        </a>
                        <a class="dropdown-item" href="{{ route('public.berita') }}" style="border-radius: 8px; padding: 10px 14px; font-size: 13px; font-weight: 600; color: #1a3a6e; display: flex; align-items: center; gap: 10px;">
                            <i class="fas fa-newspaper" style="width: 18px; color: #f5a623;"></i> Berita
                        </a>
                    </div>
                </li>
                ...
                {{-- Layanan Dropdown --}}
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navLayanan" role="button" data-toggle="dropdown" style="padding: 24px 16px; font-size: 14px; font-weight: 600; color: rgba(255,255,255,0.85); display: flex; align-items: center; gap: 6px;">
                        <i class="fas fa-concierge-bell"></i>
                        <span>Layanan</span>
                    </a>
                    <div class="dropdown-menu" style="border: none; border-radius: 12px; box-shadow: 0 12px 40px rgba(0,0,0,0.15); padding: 8px; min-width: 220px;">
                        <a class="dropdown-item" href="{{ route('public.koperasi') }}" style="border-radius: 8px; padding: 10px 14px; font-size: 13px; font-weight: 600; color: #1a3a6e; display: flex; align-items: center; gap: 10px;">
                            <i class="fas fa-users" style="width: 18px; color: #f5a623;"></i> Daftar Koperasi
                        </a>
                        ...
                        <a class="dropdown-item" href="{{ route('pelatihan') }}" style="border-radius: 8px; padding: 10px 14px; font-size: 13px; font-weight: 600; color: #1a3a6e; display: flex; align-items: center; gap: 10px;">
                            <i class="fas fa-chalkboard-teacher" style="width: 18px; color: #f5a623;"></i> Pelatihan
                        </a>
                        <a class="dropdown-item" href="{{ route('statistik.koperasi') }}" style="border-radius: 8px; padding: 10px 14px; font-size: 13px; font-weight: 600; color: #1a3a6e; display: flex; align-items: center; gap: 10px;">
                            <i class="fas fa-chart-bar" style="width: 18px; color: #f5a623;"></i> Data Statistik Koperasi
                        </a>
                ...
                <li class="nav-item dropdown {{ request()->routeIs('public.galeri*') ? 'active' : '' }}">
                    <a class="nav-link dropdown-toggle" href="#" id="navGaleri" role="button" data-toggle="dropdown" style="padding: 24px 16px; font-size: 14px; font-weight: 600; color: rgba(255,255,255,0.85); display: flex; align-items: center; gap: 6px;">
                        <i class="fas fa-images"></i>
                        <span>Galeri</span>
                    </a>
                    <div class="dropdown-menu" style="border: none; border-radius: 12px; box-shadow: 0 12px 40px rgba(0,0,0,0.15); padding: 8px; min-width: 220px; margin-top: 0;">
                        <a class="dropdown-item" href="{{ route('public.galeri') }}?tipe=foto" style="border-radius: 8px; padding: 10px 14px; font-size: 13px; font-weight: 600; color: #1a3a6e; display: flex; align-items: center; gap: 10px;">
                            <i class="fas fa-camera" style="width: 18px; color: #f5a623;"></i> Foto
                        </a>
                        <a class="dropdown-item" href="{{ route('public.galeri') }}?tipe=video" style="border-radius: 8px; padding: 10px 14px; font-size: 13px; font-weight: 600; color: #1a3a6e; display: flex; align-items: center; gap: 10px;">
                            <i class="fas fa-video" style="width: 18px; color: #f5a623;"></i> Video
                        </a>
                    </div>
                </li>
