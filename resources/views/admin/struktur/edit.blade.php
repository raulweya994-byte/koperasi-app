                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="bidang" class="form-control" required>
                            @foreach(['kepala_dinas'=>'Kepala Dinas','sekretariat'=>'Sekretariat','perdagangan'=>'Bidang Perdagangan','koperasi'=>'Bidang Koperasi','perindustrian'=>'Bidang Perindustrian'] as $val => $label)
