...
.diagonal-accent {
    ...
    width: 300px;
    height: 300px;
    background: linear-gradient(135deg, transparent 40%, rgba(255,255,255,0.05) 40%, rgba(255,255,255,0.05) 60%, transparent 60%);
...
<div class="certificate-modern" id="cert-modern">
    ...
    <div class="cert-content-modern">
        ...
        <div style="margin-bottom: 15px;">
            <div style="font-size: 11pt; font-weight: 700; color: #1e3a5f; text-transform: uppercase; letter-spacing: 1px;">
        ...
        <div class="cert-subtitle-modern">Partisipasi</div>
        
        <div style="font-size: 10pt; color: #64748b; margin-bottom: 20px;">
            Nomor: <strong style="color: #1e3a5f;">{{ $koperasi->no_registrasi }}</strong>
        </div>
        
        <div class="cert-divider-modern"></div>
        
        <div class="cert-label-modern">Diberikan kepada:</div>
        <div class="cert-name-modern">{{ $koperasi->nama_usaha }}</div>
        
        <div class="cert-desc-modern">
            Terima kasih atas partisipasinya dan memberikan performa yang luar biasa.
            Kami sangat bangga atas performa yang menakjubkan.
        </div>
        
        <div style="font-size: 10pt; color: #64748b; margin-bottom: 20px; max-width: 600px;">
