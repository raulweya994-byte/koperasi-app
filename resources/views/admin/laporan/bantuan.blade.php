            ...
            <div class="card page-header-card">
                <div class="card-body">
                    <div class="d-flex align-items-center text-white">
                        ...
                        <div>
                            <h3 class="page-header-title">Riwayat Bantuan</h3>
                            <p class="page-header-subtitle">Rekaman seluruh distribusi bantuan yang pernah dilakukan</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="filter-box">
                <form method="GET">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <a href="{{ route('admin.laporan.bantuan') }}" class="btn btn-secondary btn-block">
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                <a href="{{ route('admin.laporan.exportExcel', ['type'=>'bantuan']) }}" 
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <a href="{{ route('admin.laporan.exportWord', ['type'=>'bantuan']) }}" 
...
function printLaporan() {
    ...
    const printContent = `
        ...
        <head>
            <meta charset="utf-8">
            <title>Laporan Riwayat Bantuan</title>
            <style>
                @media print {
                    @page {
                        size: A4 landscape;
        ...
        <body>
            ...
            <div class="title">
                <h3>RIWAYAT BANTUAN KOPERASI</h3>
            </div>
