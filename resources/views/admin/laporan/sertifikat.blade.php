                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between text-white">
                        ...
                        <div class="text-right d-none d-md-block">
                            <a href="{{ route('admin.laporan.index') }}" class="btn btn-light btn-modern">
            ...
            <div class="filter-box">
                <form method="GET">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <a href="{{ route('admin.laporan.sertifikat') }}" class="btn btn-secondary btn-block">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.laporan.cetakSertifikat', $u) }}" 
                                   target="_blank" 
