...
<div class="container-fluid">
        ...
        <div class="edit-header-content">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="d-none d-md-block">
                    <a href="{{ route('admin.bantuan.show', $bantuan) }}" class="btn btn-back-modern">
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            <form action="{{ route('admin.bantuan.update', $bantuan) }}" method="POST" id="editForm">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex gap-3 mt-4 pt-4" style="border-top: 2px solid #f1f5f9;">
                    ...
                    <a href="{{ route('admin.bantuan.show', $bantuan) }}" class="btn-cancel-modern">
