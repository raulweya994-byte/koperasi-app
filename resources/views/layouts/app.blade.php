    ...
    <style>
        ...
        @php
            ...
            $themes = [
                ...
                "koperasi" => ["sidebar"=>"#1a3a6e", "header"=>"#2d5aa0", "accent"=>"#3b82f6", "label"=>"Pelaku Koperasi"],
        ...
        /* Brand link lebih compact */
        .brand-link {
            padding: 12px 15px !important;
            height: auto !important;
        }

        /* User panel lebih compact */
        .user-panel {
            padding: 12px 15px !important;
        ...
        /* Icon di dropdown/treeview lebih kecil dan rapi */
        ...
        /* Menu parent dropdown - TANPA warna berbeda */
        ...
        .nav-sidebar > .nav-item > .nav-link[href="#"]:hover {
            background: rgba(255,255,255,0.15) !important;
        }

        /* Active state untuk parent dropdown - TANPA border kuning */
        .nav-sidebar > .nav-item > .nav-link.active[href="#"] {
            background: rgba(255,255,255,0.15) !important;
        }

        /* Sub-menu (treeview) - TANPA background biru muda */
        .nav-treeview {
            background: transparent !important;
            padding: 5px 0 !important;
            margin: 0 !important;
        ...
        /* Sub-menu item hover state - TANPA slide animation */
        .nav-treeview > .nav-item > .nav-link:hover {
            background: rgba(255,255,255,0.1) !important;
            color: #ffffff !important;
        }

        /* Sub-menu item active state - TANPA border kuning */
        ...
        /* Pastikan tidak ada border saat active */
        .nav-sidebar .nav-link.active {
            border: none !important;
        }
        .nav-treeview .far.nav-icon {
        ...
        /* Right icon (arrow) di menu dengan submenu */
        .nav-sidebar .right {
            font-size: 11px !important;
            transition: transform 0.3s ease;
        }
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="min-width:350px">
                    ...
                    <div class="dropdown-footer text-center p-3">
                        <a href="{{ auth()->user()->role == 'koperasi' ? route('koperasi.notifikasi') : route('notifikasi.index') }}" class="text-primary font-weight-bold">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <div class="dropdown-footer text-center">
                        <a href="{{ 
        auth()->user()->isAdmin() ? route('admin.chat.index') : 
        (auth()->user()->isPetugas() ? route('petugas.chat.index') : 
        (auth()->user()->isPimpinan() ? route('pimpinan.chat.index') : 
        (auth()->user()->role == 'anggota' ? route('anggota.chat.index') : 
        (auth()->user()->role == 'koperasi' ? route('koperasi.chat.index') : '#')))) 
    }}" class="text-primary">Lihat semua pesan</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle user-dropdown-toggle d-flex align-items-center" data-toggle="dropdown" href="#" role="button">
                    ...
                    <div class="py-2">
                        @if(auth()->user()->isAdmin())
                            <a href="{{ route('admin.profile') }}" class="dropdown-item">
                                <i class="fas fa-user-cog fa-fw mr-2 text-primary"></i> Profil Saya
                            </a>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-3">
                <ul class="nav nav-pills nav-sidebar flex-column nav-compact nav-child-indent"
                    ...
                    <li class="nav-item has-treeview {{ request()->routeIs('admin.anggota*') || request()->routeIs('admin.kartu-sertifikat') || request()->routeIs('admin.periode-pendaftaran*') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ request()->routeIs('admin.anggota*') || request()->routeIs('admin.kartu-sertifikat') || request()->routeIs('admin.periode-pendaftaran*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-building"></i>
                            <p>Manajemen Data Koperasi
                                <i class="fas fa-angle-left right"></i>
                            </p>
                                                    </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.koperasi.index') }}" class="nav-link {{ request()->routeIs('admin.koperasi*') ? 'active' : '' }}">
                                    <i class="fas fa-store nav-icon"></i>
                                    <p>Data Koperasi
                                        @php $pendingKoperasi = \App\Models\Koperasi::where('status_verifikasi','pending')->count() @endphp
                                        @if($pendingKoperasi > 0)
                                            <span class="badge badge-warning right">{{ $pendingKoperasi }}</span>
                                        @endif
                                    </p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.anggota.create') }}" class="nav-link {{ request()->routeIs('admin.anggota.create') || request()->routeIs('admin.anggota.store') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.anggota.verifikasi') }}" class="nav-link {{ request()->routeIs('admin.anggota.verifikasi') ? 'active' : '' }}">
                                    ...
                                    <p>Verifikasi Pendaftaran
                                        @php $anggotaPending = \App\Models\Anggota::where('status','pending')->count(); @endphp
                                        @if($anggotaPending > 0)
                                        <span class="badge badge-warning right">{{$anggotaPending}}</span>
                                        @endif
                                    </p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview {{ request()->routeIs('admin.bantuan*') || request()->routeIs('admin.periode-bantuan*') || request()->routeIs('admin.penerima-bantuan*') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ request()->routeIs('admin.bantuan*') || request()->routeIs('admin.periode-bantuan*') || request()->routeIs('admin.penerima-bantuan*') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.penerima-bantuan.index') }}" class="nav-link {{ request()->routeIs('admin.penerima-bantuan*') ? 'active' : '' }}">
                                    <i class="far fa-users nav-icon"></i><p>Penerima Bantuan</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.periode-bantuan.index') }}" class="nav-link {{ request()->routeIs('admin.periode-bantuan*') ? 'active' : '' }}">
                                    <i class="far fa-calendar-check nav-icon"></i><p>Periode Bantuan</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item has-treeview {{ request()->routeIs('admin.jadwal*') || request()->routeIs('admin.struktur*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item has-treeview {{ request()->routeIs('admin.struktur*') ? 'menu-open' : '' }}">
                    ...
                    <li class="nav-item has-treeview {{ request()->routeIs('admin.berita*') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ request()->routeIs('admin.berita*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-newspaper"></i>
                            <p>Modul Informasi <i class="fas fa-angle-left right"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.berita.index') }}" class="nav-link {{ request()->routeIs('admin.berita.index') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i><p>Berita</p>
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item has-treeview {{ request()->routeIs('admin.galeri*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.galeri.index') }}?tipe=foto" class="nav-link {{ request()->routeIs('admin.galeri*') && request()->get('tipe') == 'foto' ? 'active' : '' }}">
                                    <i class="fas fa-camera nav-icon"></i><p>Foto</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.galeri.index') }}?tipe=video" class="nav-link {{ request()->routeIs('admin.galeri*') && request()->get('tipe') == 'video' ? 'active' : '' }}">
                                    <i class="fas fa-video nav-icon"></i><p>Video</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                    
                    {{-- <li class="nav-item has-treeview {{ request()->routeIs('admin.kontak*') || request()->routeIs('admin.halaman-statis*') ? 'menu-open' : '' }}">
                    ...
                    <li class="nav-item has-treeview {{ request()->routeIs('admin.anggota*') || request()->routeIs('admin.periode-pendaftaran*') ? 'menu-open' : '' }}">
                    ...
                    <li class="nav-item has-treeview {{ request()->routeIs('admin.pelatihan*') || request()->routeIs('admin.pengajuan*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.laporan.bantuan') }}" class="nav-link {{ request()->routeIs('admin.laporan.bantuan') ? 'active' : '' }}">
                                    <i class="fas fa-history nav-icon"></i><p>Riwayat Bantuan</p>
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-header">MANAJEMEN KOPERASI</li>
                    <li class="nav-item has-treeview {{ request()->routeIs('petugas.anggota-koperasi*') || request()->routeIs('petugas.anggota.create') || request()->routeIs('petugas.anggota.store') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ request()->routeIs('petugas.anggota-koperasi*') || request()->routeIs('petugas.anggota.create') || request()->routeIs('petugas.anggota.store') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-users-cog"></i>
                            <p>Manajemen Data Anggota <i class="fas fa-angle-left right"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('petugas.anggota-koperasi.index') }}" class="nav-link {{ request()->routeIs('petugas.anggota-koperasi*') ? 'active' : '' }}">
                                    <i class="fas fa-users nav-icon"></i><p>Data Anggota Koperasi</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('petugas.anggota.create') }}" class="nav-link {{ request()->routeIs('petugas.anggota.create') || request()->routeIs('petugas.anggota.store') ? 'active' : '' }}">
                                    <i class="fas fa-user-plus nav-icon"></i><p>Daftar Anggota Baru</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('petugas.jadwal.index') }}" class="nav-link {{ request()->routeIs('petugas.jadwal*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-calendar-check"></i><p>Jadwal Saya</p>
                        </a>
                    </li>
                    
                    <li class="nav-header">INFORMASI</li>
                    <li class="nav-item has-treeview {{ request()->routeIs('petugas.pengumuman*') || request()->routeIs('petugas.berita*') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ request()->routeIs('petugas.pengumuman*') || request()->routeIs('petugas.berita*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-info-circle"></i>
                            <p>Modul Informasi <i class="fas fa-angle-left right"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('petugas.pengumuman.index') }}" class="nav-link {{ request()->routeIs('petugas.pengumuman*') ? 'active' : '' }}">
                                    <i class="fas fa-bullhorn nav-icon"></i><p>Pengumuman</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('petugas.berita.index') }}" class="nav-link {{ request()->routeIs('petugas.berita*') ? 'active' : '' }}">
                    ...
                    <li class="nav-header">KOMUNIKASI</li>
                    <li class="nav-item">
                        <a href="{{ route('petugas.chat.index') }}" class="nav-link {{ request()->routeIs('petugas.chat*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-comments"></i>
                            <p>Chat & Pesan
                                @php 
                    ...
                    <li class="nav-item">
                        <a href="{{ route('petugas.settings.index') }}" class="nav-link {{ request()->routeIs('petugas.settings*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-cog"></i>
                            <p>Pengaturan</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('petugas.activity-log.index') }}" class="nav-link {{ request()->routeIs('petugas.activity-log*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item has-treeview {{ request()->routeIs('pimpinan.laporan*') ? 'menu-open' : '' }}">
                ...
                <div class="row mb-2 align-items-center">
                    <div class="col-sm-12">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <a href="{{ route('dashboard') }}" class="btn btn-sm mr-3" style="background:linear-gradient(135deg,#60a5fa,#3b82f6);color:#ffffff;border:none;border-radius:8px;padding:8px 16px;font-weight:700;box-shadow:0 2px 8px rgba(59,130,246,0.3);transition:all 0.3s">
...
<script>
$(document).ready(function() {
    // Manual treeview fix - AdminLTE fallback
    $('.nav-sidebar .nav-item.has-treeview > .nav-link').on('click', function(e) {
        e.preventDefault();
        var $item = $(this).parent();
        var $sub = $item.find('> .nav-treeview');
    ...
    // Pastikan submenu yang aktif terbuka saat load
